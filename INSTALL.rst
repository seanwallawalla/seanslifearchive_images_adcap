...
----
Installing SeansLifeArchive/Images/AdCap
----

SeansLifeArchive/Images/AdCap currently doesn't require installation, it is just a collection of images and data. It is part of the Seanpm2001 Life Archive project, and for proper "installation" the repository should be placed under /SeansLifeArchive/<yourInstalledVersion>/Resources/Images/

If you want to load the project language file, you will need to have C++ (language) installed (version 5.0 or higher)
...
----
Install instructions file version: 2 (Sunday, 2022, April 24th at 8:57 pm PST)
----
